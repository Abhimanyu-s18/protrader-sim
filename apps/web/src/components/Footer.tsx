      ...
      <div className="border-t border-white/10 bg-dark-900">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex flex-col items-start gap-4 lg:flex-row lg:items-center lg:gap-8">
            ...
            {/* Risk warning — centre */}
            <p className="flex-1 text-center text-xs leading-relaxed text-gray-600 lg:text-left">
            ...
            <p className="flex-shrink-0 whitespace-nowrap text-right text-xs text-gray-600">
