    ...
    return (
      <div className="bg-surface flex min-h-screen items-center justify-center p-4">
        <Card className="w-full max-w-md text-center">
          <h1 className="text-dark text-xl font-semibold">Check your email</h1>
  ...
  return (
    <div className="bg-surface flex min-h-screen items-center justify-center p-4">
      <Card className="w-full max-w-md space-y-3">
        <h1 className="text-dark text-2xl font-semibold">Create your account</h1>
        ...
        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="space-y-1">
            ...
            <p className="text-dark-500 text-xs font-medium">Strength: {strength.label}</p>
          </div>
